...
public class CustomExceptionHandler extends ExceptionHandlerWrapper {
	...
	public void handle() throws FacesException {
		...
		while (iterator.hasNext()) {
			...
			if(exception instanceof ErroConfirmacaoSenhaException ) {
				return;
			}
			// Aqui tentamos tratar a exeção
			try {

				// // Aqui você poderia por exemploinstanciar as classes StringWriter e
				// PrintWriter
				...
				navigationHandler.handleNavigation(facesContext, null, "/errorPage.xhtml");
